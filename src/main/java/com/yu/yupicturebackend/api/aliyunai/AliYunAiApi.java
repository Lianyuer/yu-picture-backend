package com.yu.yupicturebackend.api.aliyunai;
...
public class AliYunAiApi {
    ...
    // 创建任务地址
    private static String CREATE_OUT_PAINTING_TASK_URL = "https://dashscope.aliyuncs.com/api/v1/services/aigc/image2image/out-painting";

    // 查询任务状态地址
    private static String GET_OUT_PAINTING_TASK_URL = "https://dashscope.aliyuncs.com/api/v1/tasks/%s";
