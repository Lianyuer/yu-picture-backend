package com.yu.yupicturebackend.manager;
...
public class FileManager {
     ...
     * @param fileUrl
     */
    private void validatePictureByUrl(String fileUrl) {
        // 1、参数校验
        ...
        ThrowUtils.throwIf(!(fileUrl.startsWith("http://")) || !fileUrl.
                        startsWith(("https://")),
                ErrorCode.PARAMS_ERROR, "仅支持 HTPP 或 HTTP协议的文件地址");
